...
telem_reindeer <- read_sf('analysis/real_analysis/dataset/reindeer_gps/gps_data_reindeer.shp') %>% 
...
reindeer_areas <- read_sf('analysis/real_analysis/dataset/reindeer_areas/reindeer_areas.shp') %>% 
  st_transform(crs = 25833)
